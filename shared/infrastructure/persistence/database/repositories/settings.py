...
class Settings(BaseSettings):
    ...
    # Database Settings
    DATABASE_HOST: str = "supabase-host"
    DATABASE_PORT: int = 5432
    DATABASE_NAME: str = "db-name"  # nombre de la BD
    DATABASE_USER: str = "user-name"  # nombre de usuario
    DATABASE_PASSWORD: str = "db-password"  # contraseña
    ...
    # BLOB Storage
    MODEL_BLOB_URL: str = "https://devbeans.blob.core.windows.net/ml-models/defect_detector.h5"
